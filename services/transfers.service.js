...
export async function create_transfer(userid, data) {
    ...
    await conexion.query('INSERT INTO history (owner, amount, leals_amount, date, currency, destinary_transfer, cash_flow, history_type) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)', [userid, data.amount, data.amount / p2p_config.value_compared_usdt, new Date(), 'usdt', data.destinary, 'outcome', 'transfer'])
